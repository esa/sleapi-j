...
public class EE_APISE_RCF_URSITest
{
    EE_APISE_RCF_URSI obj;
    ...
    {
        this.version = 1;
        this.obj = new EE_APISE_RCF_URSI(EE_SLE_LibraryInstance.LIBRARY_INSTANCE_KEY, this.serviceInfo);
    ...
    public void testDoInitiateOpInvoke() throws SleApiException
    {
        ...
        EE_SLE_Bind bindOp = new EE_SLE_Bind(SLE_ApplicationIdentifier.sleAI_rtnChFrames, this.version, this.reporter);
        ...
        bindOp.setServiceType(SLE_ApplicationIdentifier.sleAI_rtnChFrames);
        ...
        EE_SLE_Unbind unBindOp = new EE_SLE_Unbind(SLE_ApplicationIdentifier.sleAI_rtnChFrames,
                                                   this.version,
                                                   this.reporter);
        ...
        EE_RCF_Start opStart = new EE_RCF_Start(this.version, this.reporter);
        hr = this.obj.doInitiateOpInvoke(opStart);
        assertEquals(HRESULT.SLE_E_INVALIDID, hr);

        /************************ Operation: EE_SLE_Stop ****************************/
        EE_SLE_Stop opStop = new EE_SLE_Stop(SLE_ApplicationIdentifier.sleAI_rtnChFrames, this.version, this.reporter);
        hr = this.obj.doInitiateOpInvoke(opStop);
        assertEquals(HRESULT.SLE_E_PROTOCOL, hr);

        /************************ Operation: EE_SLE_ScheduleStatusReport ****************************/
        EE_SLE_ScheduleStatusReport scheduleStatusOp = new EE_SLE_ScheduleStatusReport(SLE_ApplicationIdentifier.sleAI_rtnChFrames,
                                                                                       this.version,
                                                                                       this.reporter);
        ...
        EE_RCF_GetParameter getParamOp = new EE_RCF_GetParameter(this.version, this.reporter);
        hr = this.obj.doInitiateOpInvoke(getParamOp);
        assertEquals(HRESULT.SLE_E_MISSINGARG, hr);

        /************************ Operation: EE_SLE_PeerAbort ****************************/
        EE_SLE_PeerAbort peerAbortOp = new EE_SLE_PeerAbort(SLE_ApplicationIdentifier.sleAI_rtnChFrames,
                                                            this.version,
                                                            this.reporter);
